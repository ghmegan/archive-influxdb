...
abstract public class AbstractRDBValueIterator  implements ValueIterator
{
    ...
    private Display determineDisplay() throws Exception
    {
        ...
        //                reader.getConnection().prepareStatement(reader.getQuery().numeric_meta_sel_by_channel);
        //        try
        //        {
     ...
     */
    protected VType decodeSampleTableValue(final QueryResult result, final boolean handle_array) throws Exception
    {
        final Instant time = null;
        final String status = null;
        final AlarmSeverity severity = null;
        final String txt = null;
        //        // Get time stamp
            ...
            final AlarmSeverity severity) throws Exception
    {
        ...
        //                    reader.getQuery().sample_sel_array_vals);
        //        }
     ...
     *  @throws Exception on error, including 'cancel'
     */
    private double[] readBlobArrayElements(final double dbl0, final QueryResult result) throws Exception
    {
     ...
     *  @throws Exception on error
     */
    protected void dumpResultSet(final QueryResult result) throws Exception
    {
